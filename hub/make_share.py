...
INCLUDE_FILES = [
    ...
    ("OTA Close/vi.py", "Viator 마감/오픈"),
    ("OTA Close/vi_targets.py", "Viator 상품 목록"),
    ("OTA Close/mrt.py", "MyRealTrip 마감/오픈"),
    ("OTA Close/tpc.py", "TPC(Trip.com) 마감/수집/오픈"),
    ("OTA Close/tpc_dom.py", "TPC 화면 조작"),
    ("OTA Close/tpc_targets.py", "TPC 상품 목록"),
    ("OTA Close/gui.py", "마감 PC 창 (start_gui.bat 이 부른다)"),
